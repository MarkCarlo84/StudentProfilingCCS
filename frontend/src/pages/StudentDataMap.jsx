                                            ...
                                            {groupStudents.map((stu, idx) => {
                                                ...
                                                return (
                                                    <tr key={stu.id}>
                                                        ...
                                                        <td>
                                                            <div style={{ fontWeight: 700, fontSize: '.875rem', color: '#1c1917', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{stu.last_name}, {stu.first_name}{stu.middle_name ? ` ${stu.middle_name[0]}.` : ''}</div>
