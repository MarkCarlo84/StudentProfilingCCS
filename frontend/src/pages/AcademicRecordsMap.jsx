            ...
            <div style={{ ...modalCard, maxWidth: 900, width: '95vw', maxHeight: '92vh', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ overflowY: 'auto', flex: 1, display: 'flex', flexDirection: 'column', gap: 14, minHeight: 0 }}>
                    {semesters.map((sem, si) => {
                        ...
                        return (
                            <div key={si} style={{ border: `1.5px solid ${semStanding === 'irregular' ? '#fde68a' : '#e2e8f0'}`, borderRadius: 14, overflow: 'visible' }}>
                                ...
                                <table style={{ width: '100%', minWidth: 560, borderCollapse: 'collapse', fontSize: '.82rem' }}>
                                    <thead>
